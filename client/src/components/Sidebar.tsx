  ...
  return (
    <div className="w-64 bg-sidebar text-white flex flex-col">
      ...
      <div className="p-4 border-b border-gray-600">
        <div className="text-xs text-gray-400 uppercase tracking-wide mb-2">Organization</div>
        <Select 
          value={currentOrganization?.id || ""} 
          onValueChange={switchOrganization}
        >
          <SelectTrigger className="w-full bg-sidebar-hover text-white border-gray-600">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <div className="border-t border-gray-600 my-4 pt-4">
          <div className="text-xs text-gray-400 uppercase tracking-wide mb-2 px-3">Administration</div>
          {adminItems.map((item) => {
            const Icon = item.icon;
